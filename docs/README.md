...
This directory contains the product and technical specifications for the features in this project.

## Feature Dashboard

- [x] **Project Initialization** (`Completed`) — 2026-04-23
...
- [ ] **Hono Org Units Best Practices** (`Draft`) — [View Spec](./specs/hono-org-units-best-practices.md) — 2026-05-13
